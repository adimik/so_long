...
/*   Updated: 2025/02/13 16:31:49 by didimitr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
        ...
        int height)
{
    ...
    data = (int *)mlx_get_data_addr(img, &info.bits_per_pixel, &info.line_length,
            &info.endian);
    new_data = (int *)mlx_get_data_addr(new_img, &info.bits_per_pixel, &info.line_length,
            &info.endian);
